...
import com.oppo.postureguard.training.CoachTrainingV2Activity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun openTraining(courseId: String) {
        val intent = Intent(this, CoachTrainingV2Activity::class.java).apply {
            putExtra(CoachTrainingV2Activity.EXTRA_COURSE_ID, courseId)
        }
        startActivity(intent)
    }
}